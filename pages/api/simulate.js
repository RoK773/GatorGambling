...
// const OLLAMA_URL = process.env.OLLAMA_URL || 'http://localhost:11434'; //ngrok url for the ollama server, since we can't call it directly from the frontend
// //const OLLAMA_URL = 'http://localhost:11434'; //before ngrok
...
//     const teams = await fetchingfromAPI(
...
//     console.log('Matched team:', team.name);
//     console.log('Matched team id:', team.id);
...
//     }
//     catch{
//         throw new Error(`Invalid JSON from Omalla ${response.status}`);
//     }
